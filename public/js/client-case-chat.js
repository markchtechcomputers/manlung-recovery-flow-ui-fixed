(() => {
  ...
  function styles(){
    ...
    const s=document.createElement('style'); s.id='mlc-style'; s.textContent=`
      ...
      .mlc-compose{padding:.8rem;background:#0a1727;border-top:1px solid rgba(148,163,184,.1)}.mlc-row{display:flex;gap:.55rem;align-items:flex-end}.mlc-input{flex:1;min-height:52px;max-height:140px;resize:none;border:1px solid rgba(148,163,184,.2);border-radius:13px;background:#0f1d2e;color:#f8fafc;padding:.75rem .8rem;outline:none;font:inherit;font-size:.8rem}.mlc-input:focus{border-color:rgba(96,165,250,.65);box-shadow:0 0 0 3px rgba(37,99,235,.1)}.mlc-send{min-width:88px;height:48px;padding:0 .9rem;display:inline-flex;align-items:center;justify-content:center;gap:.42rem;border:0;border-radius:13px;background:#2563eb;color:#fff;cursor:pointer;font:inherit;font-size:.78rem;font-weight:800;box-shadow:0 7px 18px rgba(37,99,235,.25);transition:transform .15s ease,opacity .15s ease,background .15s ease}.mlc-send:hover{background:#1d4ed8;transform:translateY(-1px)}.mlc-send:active{transform:translateY(0)}.mlc-send:disabled{opacity:.55;cursor:not-allowed;transform:none}.mlc-note{display:flex;justify-content:space-between;gap:.5rem;margin-top:.45rem;color:#64748b;font-size:.64rem}.mlc-error{display:none;margin:.55rem 1rem 0;padding:.55rem .7rem;border-radius:9px;background:rgba(239,68,68,.08);border:1px solid rgba(248,113,113,.18);color:#fca5a5;font-size:.7rem}
      @media(max-width:600px){.mlc-head{padding:.85rem}.mlc-info{padding:.55rem .85rem}.mlc-list{height:55vh;min-height:300px}.mlc-bubble{max-width:91%}.mlc-row{gap:.4rem}.mlc-send{min-width:82px;height:46px;padding:0 .7rem;font-size:.74rem}}
